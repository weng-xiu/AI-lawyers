...
<script>
import { listCategory, getCategory, delCategory, addCategory, updateCategory, exportCategory } from "@/api/lawyers/category"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除咨询分类编号为"' + categoryIds + '"的数据项？').then(function() {
